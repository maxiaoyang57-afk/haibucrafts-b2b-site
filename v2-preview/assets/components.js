(() => {
  ...
  const footer = `
    <footer class="site-footer"><div class="container">
      <div class="footer-grid footer-grid-v2">
        ...
        <div><h3>Company</h3><a href="${ROOT}about/">About HAIBUCRAFT</a><a href="${ROOT}about/#transparency">Transparency</a><a href="${ROOT}about/editorial-policy/">Editorial Policy</a><a href="${ROOT}privacy/">Privacy Policy</a><button class="footer-cookie-settings" type="button" data-cookie-settings>Cookie choices</button><a href="${ROOT}certificates/">Document Center</a><a href="${ROOT}quote/?source=footer-company&landing_page=${landing}">Contact Sales</a></div>
      </div>
  ...
  consentBanner.innerHTML = `
    <div class="analytics-consent-copy">
      ...
      <p id="analytics-consent-description">We use Google Analytics to understand how visitors use our website. Analytics cookies are used only if you accept. You can change your choice at any time. <a href="${ROOT}privacy/">Privacy policy</a></p>
    </div>
