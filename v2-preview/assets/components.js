  ...
  const footer = `
    <footer class="site-footer"><div class="container">
      <div class="footer-grid footer-grid-v2">
        ...
        <div><h3>Buyer Resources</h3><a href="${ROOT}blog/">Buying Guides</a><a href="${ROOT}blog/wholesale-product-brief/">Product Brief Guide</a><a href="${ROOT}blog/custom-sample-approval/">Sample Approval Guide</a><a href="${ROOT}blog/packaging-quality-checkpoints/">Packaging &amp; QC Guide</a></div>
