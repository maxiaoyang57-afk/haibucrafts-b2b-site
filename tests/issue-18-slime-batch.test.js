...
test('Issue #18 keeps its original SKUs after later catalog additions and preserves legacy SLM10012', async () => {
  ...
  assert.match(home, /<b>139<\/b><span>Cataloged wholesale products<\/span>/);
  ...
  assert.match(directory, /<b>139<\/b><span>Published products<\/span>/);
